        ...
        <div class="col-8">
            <form action="{{route('student.update')}}" method="post" class="registration-form w-50">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reg_no" class="form-control" placeholder="register no"
                           value="{{$student->reg_no}}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ph_no" class="form-control" placeholder="phone no"
